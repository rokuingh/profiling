...
if not os.path.isfile(timeoutfilename):
    ...
    out.write("proc count\tsrc create esmf\tdst create esmf\tregrid esmf\tsrc destroy esmf\tdst destroy esmf\tsrc create moab\tdst create moab\tregrid moab\tsrc destroy moab\tdst destroy moab\n")
else:
